...
<div class="container" id="content">
    <img src="img\boys.jpg" style="float: left;">
    <div class="row">
        <div class="col-lg-4" align="justify">
            <h3><mark>WHO WE ARE</mark></h3><br>
            <p id="p1">My store is a recognized leader in the ecommerce industry, with a steadfast commitment to success and a record of achievement that continues a tradition of delivering excellence.<br><br>The company was founded in 2023 by Mahendra, Mohinish Mukherjee and Priyanshu to ease the process of ordering various items. From those early days with just one employee, Lifestyle Store now has more than 10000 employees, serving thousands of customers. <br><br>Lifestyle Store is guided by four principles: customer obsession rather than competitor focus, passion for invention, commitment to operational excellence, and long-term thinking.<br><br><h4><mark>Vision</mark></h4>To make the world a more stylish, colorful and happier place.<br><br><h4><mark>Mission</mark></h4>We strive to offer our customers the lowest possible prices, the best available selection, and the utmost convenience.
            </p>
        </div>
        <div class="col-lg-4" align="justify">
